...
import {getAllElements} from './modules/elements.js';
import {renderGoods} from './modules/render.js';
import {recalculateTotalPrice} from './modules/utilities.js';
...

{
  ...
  const init = () => {
    ...
    const {
      formOverlay, modal, addButton, totalPrice, list,
      checkbox, discountCode, output, count, price, form,
    } = getAllElements();
